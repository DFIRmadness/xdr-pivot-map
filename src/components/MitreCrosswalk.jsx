        ...
        {!tactic ? (
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13, color: "var(--tx-2)", lineHeight: 1.8, display: "block", borderTop: "1px solid var(--bd-1)", paddingTop: 14, marginTop: 4 }}>
              <span style={{ display: "inline-block", transform: "scale(4.0)", transformOrigin: "center", marginRight: 24 }}>⚠</span> The technique mappings and KQL queries are AI-driven and meant to drive ideas — they may not be 100% accurate for every environment. Treat them as a starting point, not a definitive reference.
            </span>
          </div>
        ) : (
