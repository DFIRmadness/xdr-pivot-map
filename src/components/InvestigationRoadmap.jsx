        ...
        {!activeType ? (
          <div style={{
            ...
            <span style={{ fontSize: 13, color: "var(--tx-2)", lineHeight: 1.8, display: "block", borderTop: "1px solid var(--bd-1)", paddingTop: 14, marginTop: 4 }}>
              <span style={{ fontSize: "1.1em" }}>⚠</span> The investigation roadmaps are AI-driven rough sketches of how an investigation might look — meant to drive ideas, not prescribe exact steps. Treat them as a starting point, not a definitive playbook.
            </span>
          </div>
        ) : (
